...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CfW4_kAM.js");
...
const manifest = { "6154ff9ba122adcee8332d695693036b02edeab9765af4af6c11e985f19736d6": {
  functionName: "fetchAuth_createServerFn_handler",
  importer: () => import("./assets/__root-Dl0h-fTt.js")
} };
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-CozkPsbM.js").then((n) => n.r);
    }
    if (startEntry === null) {
