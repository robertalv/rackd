...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@rackd/ui/components/sheet"
import { Skeleton } from "@rackd/ui/components/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from "@rackd/ui/components/tooltip"
...
function SidebarProvider({
  ...
  // Get initial state from cookie, but start with default to avoid hydration mismatch
...
function SidebarMenuItem({ className, disabled = false, ...props }: React.ComponentProps<"li"> & { disabled?: boolean }) {
  return (
    <li
